...
// 	
	var meshU = new THREE_Surface({
		vertices : bezierSurface.createMeshU(bezierSurface.controlPoints),
		material : new THREE.LineBasicMaterial({color: 0xff00ff})
	});
	meshU.create();
	//scene.add(meshU.node);
// 	
	var meshV = new THREE_Surface({
		vertices : bezierSurface.createMeshV(bezierSurface.controlPoints),
		material : new THREE.LineBasicMaterial({color: 0x00ffff})
	});
	meshV.create();
	//scene.add(meshV.node);
// 	
	...
	scene.add(mesh.node);
// 	
	bezierSurface.createMeshVU();
	var mesh2 = new THREE_Surface({
		vertices : bezierSurface.vertices,
		material : new THREE.LineBasicMaterial({color: 0xff0000})
	});
	mesh2.create();
	//scene.add(mesh2.node);
